...
function Research() {
  ...
  const [getDataByName, all] = useLazyQuery(FETCH_MOVIES_BY_NAME, {
    variables: { researchInField: researchField },
  });
    ...
    <div className={classes.main}>
      ...
      {data && (
        <AllMovieList
          allView={allView}
          data={
            all && all.data && all.data.getMoviesByName && !allView
              ? all.data.getMoviesByName
              : data.getAllMovies
          }
        />
      )}
